...
// Changed to be int instead of void, got rid of void parameter
int main ()
{
...
void getData(int* valuePtr)
{
	...
	/* Commented out the temp value. Assiging the pointer to the temp value
	defeates the purpose of passing in a pointer. Now is modifies the value
	at myValue */
